  ...
  return (
    <div className="cohort-list">
      <div className="cohort-list__container">
        <h2 className="cohort-list__container__filter-title">
          {filter
            ? `Showing ${handleFilterTitle(filter)}`
        ...
        <button
          className="cohort-list__container__filter-btn"
          onClick={() => handleFilter("Winter2026")}
        >
          Winter 2026
        </button>
        <button
          className="cohort-list__container__filter-btn"
          onClick={() => handleFilter("Fall2026")}
        >
          Fall 2026
        </button>
        <button
          className="cohort-list__container__filter-btn"
          onClick={() => handleFilter("Summer2026")}
        >
          Summer 2026
        </button>
        <button
          className="cohort-list__container__filter-btn"
          onClick={() => handleFilter("Spring2026")}
        >
          Spring 2026
        </button>
        <button
          className="cohort-list__container__filter-btn"
          onClick={() => handleFilter("Winter2025")}
        >
          Winter 2025
        </button>
        <button
          className="cohort-list__container__filter-btn"
          onClick={() => handleFilter("Fall2025")}
        >
          Fall 2025
        </button>
        <button
          className="cohort-list__container__filter-btn"
          onClick={() => handleFilter("Summer2025")}
        >
          Summer 2025
        </button>
        <button
          className="cohort-list__container__filter-btn"
          onClick={() => handleFilter("Spring2025")}
        >
          Spring 2025
        </button>
      </div>
